...
export const metadata = {
  ...
  description: "Søk etter turområder, DNT-hytter og fjelltoppar.",
};
    ...
    <div className="min-h-screen flex flex-col bg-[#f5f0eb] font-sans">
      ...
      <nav className="flex items-center justify-between px-8 py-5">
        ...
        <div className="flex items-center gap-6 text-sm text-[#4a6741]">
          ...
          <Link href="/klassiske-ruter" className="hover:text-[#2d4a2d] transition-colors">
            Klassiske ruter
          </Link>
          <Link href="/kart" className="hover:text-[#2d4a2d] transition-colors">
            Kart
          </Link>
        </div>
      </nav>
